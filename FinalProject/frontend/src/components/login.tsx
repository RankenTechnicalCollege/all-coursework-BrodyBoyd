...
function Login() {
  ...
  function handleSubmit<T>(email: T, password: T): T | undefined {
				...
				<div className="container mx-auto px-4">
					<div className="flex items-center justify-between py-4">
						...
						<div className="hidden sm:flex sm:items-center">
							...
							<a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Bugs</a>
							<a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Users</a>
					...
					<div className="block sm:hidden bg-white border-t-2 py-2">
						<div className="flex flex-col">
							<a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Home</a>
							<a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Bugs</a>
							<a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Marketplace</a>
							<a href="#" className="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">My Account</a>
                ...
                <div className="flex flex-col w-full md:w-1/2 p-4">
                    <div className="flex flex-col flex-1 justify-center mb-8">
                        ...
                        <div className="w-full mt-4">
                            <form className="form-horizontal w-3/4 mx-auto" method="POST" onSubmit={() => handleSubmit(email, password)}>
                                ...
                                <div className="flex flex-col mt-3">
                                    <button type="button" className="bg-gray-500 hover:bg-gray-100 text-sm font-semibold py-2 px-4 rounded">
                                        Register
                                    </button>
                                </div>
                            </form>
